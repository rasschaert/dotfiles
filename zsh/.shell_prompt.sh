...
function __promptline {
  ...
  local a_bg="${wrap}48;5;221${end_wrap}"
  local a_sep_fg="${wrap}38;5;221${end_wrap}"
  local b_fg="${wrap}38;5;252${end_wrap}"
  local b_bg="${wrap}48;5;238${end_wrap}"
  local b_sep_fg="${wrap}38;5;238${end_wrap}"
  local c_fg="${wrap}38;5;222${end_wrap}"
  ...
  local z_bg="${wrap}48;5;221${end_wrap}"
  local z_sep_fg="${wrap}38;5;221${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
